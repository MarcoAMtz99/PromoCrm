<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <!-- Navigation Links -->
                  <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('Precargas')">
                        {{ __('Precargas') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                 ...
                 <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('meidicos')">
                        {{ __('Medicos') }}
                    </x-jet-nav-link>
                </div>
                 <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                 ...
                 <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('hospitales')">
                        {{ __('Hospitales') }}
                    </x-jet-nav-link>
                </div>
                 <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('Medicos')">
                {{ __('Medicos') }}
            </x-jet-responsive-nav-link>
